...
# GRAFICO
# =================================================================================
plt.plot(np.array(np.transpose(valores_pixeles_entrenamiento[np.array(clase_entrenamiento)=='M',:])),'r',alpha=0.4)
plt.plot(np.array(np.transpose(valores_pixeles_entrenamiento[np.array(clase_entrenamiento)=='S',:])),'g',alpha=0.4)
plt.legend()
